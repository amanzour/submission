...
from src.data.sec_struct_utils import pdb_to_sec_struct, pdb_to_sec_struct_amir
...
def pdb_to_tensor_amir(
    ...
    if return_sec_struct:
        # get secondary structure
        sec_bp, fr3d_bp = pdb_to_sec_struct_amir(filepath, fr3d_filepath, sequence, pdb_map, keep_pseudoknots)
    ...
    return sequence, coords, sec_struct, sasa, sec_bp, fr3d_bp

def get_twist_amir(x, i, j, unpaired_pos, unpaired_idx):
    my_twist = 0.0
...
def dist_amir(V1: torch.Tensor, V2: torch.Tensor) -> torch.Tensor:
