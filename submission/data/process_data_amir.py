...
from src.data.data_utils import pdb_to_tensor, pdb_to_tensor_amir, get_c4p_coords
...
if __name__ == "__main__":
    ...
    for filename in filenames:
        try:
            ...
            sequence, coords, sec_struct, sasa, sec_bp, fr3d_bp = pdb_to_tensor_amir(
            ...
            if sequence in seq_to_data.keys():
                ...
                seq_to_data[sequence]['sec_bp_list'].append(sec_bp) #amir
                seq_to_data[sequence]['sec_fr3d_list'].append(fr3d_bp) #amir
